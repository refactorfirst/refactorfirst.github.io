// Type-ahead search backed by the repositories.txt listing. DOM glue
// (createSearch) is unchanged; navigation is injected by the caller
// (React components pass onNavigate -> router.push).

import { buildRepositoryListUrl } from './routes.js';
