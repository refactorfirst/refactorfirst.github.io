...
/** Converts a cell value into a normalized numeric or textual sort value. */
...
/** Compares two normalized, non-null sort values. */
...
/** Builds default searchable text from a row when no accessor is supplied. */
...
export function escapeCsvValue(value) {
  ...
  // Neutralize spreadsheet formulas: a report can plant values starting with
  // =, +, - or @ (possibly behind whitespace) that Excel/Sheets would
  // evaluate on open; an apostrophe prefix keeps them as inert text.
...
/** Creates and activates a temporary browser download link for CSV text. */
...
/** Copies text through the legacy DOM API when Clipboard API access is unavailable. */
